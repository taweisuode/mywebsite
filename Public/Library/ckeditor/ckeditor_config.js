CKEDITOR.editorConfig = function( config ) {
    ...
    // 是否转换一些特殊字符为ASCII字符 如"This is Chinese: 汉语."转换为"This is Chinese:
	// 汉语." plugins/entities/plugin.js
	...
	config.BasePath = "/assets/third_party/ckeditor/" ;//一定要指定editor文件夹所在的路径，并且要以'/'结尾  
