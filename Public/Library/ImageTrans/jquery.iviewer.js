    ...
    $iv.fn.extend({
        ...
        **/
        ...
        rotate_left:function(){
            var img = this.img_object.object[0];
            this.settings.rotate+=90
            $(img).css({"transform":'rotate('+this.settings.rotate+'deg)'})
        },
        ...
        **/
        createui: function()
        {
            ...
            $("<div>").addClass("iviewer_rotate_left").addClass("iviewer_common").
                addClass("iviewer_button").
                mousedown(function(){
                    me.rotate_left()
                    return false;
                }).appendTo(this.container);
            $("<div>").addClass("iviewer_rotate_right").addClass("iviewer_common").
                addClass("iviewer_button").
                mousedown(function(){
                    me.rotate_right()
                    return false;
